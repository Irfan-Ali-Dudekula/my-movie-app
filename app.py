...
# --- INITIALIZATION: Prevents attribute crashes ---
...
# --- STABILIZATION: Prevents [Errno 24] Too many open files ---
@st.cache_resource
...
if not st.session_state.logged_in:
    ...
    if st.button("Generate Recommendations 🚀"):
        if sel_mood != "Select" and sel_lang != "Select":
            ...
            # SMART FALLBACK: Tries India OTT first
            ...
            if not results:
                st.info("Showing popular titles (Specific OTT links not found).")
            ...
            if results:
                ...
                processed = 0
                for item in results:
                    if processed >= 75: break # Capacity
