...
# --- 1. GLOBAL SESSION FIX (Prevents Errno 24) ---
# Reusing a persistent session stops the "Too many open files" crash
...
if not st.session_state.logged_in:
    ...
    def get_cached_details(m_id, m_type):
        """Caches data to handle massive traffic and reuse connections"""
        try:
        ...
        try:
            ...
            if results:
                ...
                for item in results:
                    ...
                    # MANDATORY OTT FILTER: Only show streaming-ready content
