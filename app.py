...
if 'logged_in' not in st.session_stateimport streamlit as st
from tmdbv3api import TMDb, Movie, TV, Discover, Search
from datetime import datetime
import requests
from requests.adapters import HTTPAdapter
...
if not st.session_state.logged_in:
    ...
    if st.button("Generate Recommendations 🚀"):
        if sel_mood != "Select" and sel_lang != "Select" and sel_era != "Select":
            ...
            if not results:
                st.info("No direct India streaming links found. Showing all popular titles instead!")
            ...
            if results:
                ...
                processed = 0
                for item in results:
                    if processed >= 75: break # Locked to 75 as requested
