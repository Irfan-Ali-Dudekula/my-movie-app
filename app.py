...
def apply_styles():
    # UPDATED: Using your new Royal IMAX background for Light Theme
    light_img = "http://googleusercontent.com/image_generation_content/1" 
...
if not st.session_state.logged_in:
    ...
    # RECTIFIED MOODS with Age Check
    ...
    if st.button("Generate Recommendations 🚀") or search_query:
        ...
        if search_query:
            ...
            # FIXED: Corrected parameter names for TV Shows vs Movies
            ...
            if not results:
                st.info("Expanding search to popular titles (Limited India OTT links found).")
